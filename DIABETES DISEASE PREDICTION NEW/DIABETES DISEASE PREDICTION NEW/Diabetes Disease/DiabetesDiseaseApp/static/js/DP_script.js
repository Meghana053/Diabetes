  ...
  function checkFields(f1) {
    ...
    if (!(f1.t3.value == 0 || f1.t3.value == 1)) {
        alert("Please Enter Frequent Urination either 0 or 1");
        f1.t3.focus();
        return false;
      }

      if (!(f1.t4.value == 0 || f1.t4.value == 1)) {
        alert("Please Enter Increased Thirst either 0 or 1");
        f1.t4.focus();
        return false;
      }

      if (!(f1.t5.value == 0 || f1.t5.value == 1)) {
        alert("Please Enter Partial Paralysis either 0 or 1");
        f1.t5.focus();
        return false;
      }
      ...
      if (!(f1.t9.value == 0 || f1.t9.value == 1)) {
        alert("Please Enter Hair Loss either 0 or 1");
        f1.t9.focus();
        return false;
      }
